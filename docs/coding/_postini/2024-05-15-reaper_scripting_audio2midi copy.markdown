...
figure: /assets/images/audiotomidi.png
---
...
> 🎶 [github repo](https://github.com/mauriziobrt/reaper-basic-pitch.git)

<br>

![/assets/images/audiotomidi.png](/assets/images/audiotomidi.png)

Script developed using REAPER's ImGui library, leveraging Spotify's Basic Pitch tool for audio-to-MIDI conversion.
...
<!-- <img src="/assets/images/audiotomidi.png" style="float: right;" width="50%"/> -->
