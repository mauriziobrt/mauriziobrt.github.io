...
<div class="py-12 px-6 text-6xl tracking-tighter text-left">
    I'm a <i>composer</i>, <i>researcher</i>, and <i>software developer</i>. <br>
    Currently focusing on the creation of new instruments for sonic/musical expression. <br>
    Working with <i>machine learning</i> in music and <i>computer-assisted composition</i>.
</div>
